...
function UserForm({ addUser, closeForm }) {
  return (
    <Formik
      initialValues={{
        name: "",
    ...
    >
      <Form>
        ...
        <div className='form-group'>
          ...
          <Field className="form-control" name='phone' type='text' placeholder='Phone' />
        </div>
        ...
        <div className='form-group'>
          ...
          <Field className="form-control" name='address' type='text' placeholder='Address' />
        </div>
